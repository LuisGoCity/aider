...
"""
            ...
            with (
                ...
                # Mock an invalid response from the number_of_steps_worker
                mock_run.return_value = "I'm not sure how many steps there are."
                
                # Call the function
                commands.cmd_code_from_plan(str(plan_file))
                
                # Verify fallback behavior
                mock_tool_output.assert_any_call("Unable to determine number of steps. Will try to solve them all at once.")
